   ...
   <body>
      ...
      <div class="header-outs" id="header">
         ...
         <div class="header-w3layouts">
            <div class="hedder-up">
               <h1><a class="navbar-brand" href="index"><span class="fab fa-accusoft"></span><br>10ESSAYS</a></h1>
            </div>
         ...
         <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="row contact-right mt-lg-5 mt-md-4 mt-3">
               ...
               <div class="col-lg-4 col-md-4 footer_grid_left text-center">
                  ...
                  <p>+(254) 0716849963 <br>+(254) 0797361729</p>
               </div>
               <div class="col-lg-4 col-md-4 footer_grid_left text-center">
                  <div class="contact_footer_grid_left text-center mb-3">
                     <h4>Email</h4>
                  </div>
                  <p><a href="mailto:10essays@gmail.com">10essays@gmail.com</a> 
                     <br><a href="mailto:10essays@gmail.com">10essays@gmail.com</a>
                  </p>
               </div>
            </div>
            <!--//contact-map -->
