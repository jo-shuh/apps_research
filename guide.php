...
<body style="background-color: #f5f5f5">
        ...
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="#" class="nav-link scrollto active"><i class="bx bx-book-content"></i> <span>Writing Guide</span></a></li>
                    <li><a href="blog" class="nav-link scrollto active"><i class="bx bx-align-middle"></i> <span>Blog</span></a></li>
                </ul>
            </nav><!-- .nav-menu -->
            <div class="offer1">
    ...
    <main id="main">
        ...
        $result = mysqli_query($con, "SELECT * FROM `articles` WHERE `essay_type` = 'Writing Guide' ORDER BY `id` ASC LIMIT 60");
